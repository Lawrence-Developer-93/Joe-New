...
@section('content')
  <div>
    <div class="row">
      <div class="col-md-10">
        <h1>{{$project->title}}</h1>
        <h6>This is where all of your projects are located. - @ {{$project->user->name}}</h6>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="row">
              ...
              <div class="col-md-2">
                <center>
                  ...
                  <a href="/account/projects/{{$project->id}}/delete" onclick="confirm('Are you sure about that?')" class="delete-btn">Delete</a>
                </center>
              </div>
            </div>
          </div>
